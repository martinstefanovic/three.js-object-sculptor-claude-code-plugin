...
The script only aligns and packages evidence. It must not calculate the acceptance score. Claude's vision (read the image with the Read tool) must inspect `comparison.png`.
