...
4. Inspect the sheet once with Claude's vision (read the image with the Read tool) and score the global image, relevant visual layers, and each selected semantic feature visible in that pair.
