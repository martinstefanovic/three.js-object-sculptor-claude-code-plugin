...
<p align="center">
  <img src="examples/jeep-wrangler/render.png" alt="Jeep Wrangler reconstructed in Three.js, with the reference photo inset" width="680">
</p>
<p align="center"><em>From a single reference photo (bottom-left inset) to a self-contained Three.js scene built entirely with code — see <a href="examples/jeep-wrangler/">examples/jeep-wrangler/</a>.</em></p>
